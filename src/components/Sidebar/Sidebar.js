...
const Sidebar = () => {
  ...
  const SidebarLinks = [
    { label: "Home", route: "/home", icon: <BiHomeAlt2 className="text-[24px]" /> },
    { label: "My Banks", route: "/banks", icon: <BiDollarCircle className="text-[24px]" /> },
      ...
      <div className="drawer-side">
        ...
        <ul className="menu bg-base-200 text-base-content min-h-full w-[280px] max-w-[280px] p-4 flex flex-col items-center justify-between" style={{ userSelect: 'none' }}>
          <div>
            ...
            <div className="w-full flex flex-col font-semibold leading-[24px] text-[16px]">
              {SidebarLinks.map((link, index) => (
                <Link key={index} to={link.route} className={buttonStyle}>
          ...
          <div className="flex items-center justify-start gap-[22px]">
            ...
            <button onClick={Logout} className="flex items-center justify-end w-full">
