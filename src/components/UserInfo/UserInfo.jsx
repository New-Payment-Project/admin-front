...
const UserInfo = () => {
  ...
  return (
    <div>
      <div className='flex items-center lg:justify-between justify-center absolute bottom-3 left-7'>
        <p className='text-gray-600 px-1 py-2 rounded-lg lg:bg-base-300'>{username}</p>
