  ...
  return (
    <div className="modal modal-open">
      <div className="modal-box">
        ...
        {/* New Fields */}
        <p><strong>{t("client-phone")}:</strong> {selectedOrder.clientPhone || t("no-data")}</p>
        <p><strong>{t("client-address")}:</strong> {selectedOrder.clientAddress || t("no-data")}</p>
        <p><strong>{t("tg-username")}:</strong> {selectedOrder.tgUsername || t("no-data")}</p>
        <p><strong>{t("passport")}:</strong> {selectedOrder.passport || t("no-data")}</p>
